...
const app = new Vue({
    ...
    data:{ 
        ...
        questionObject:{
            previa: ["¿Verano o invierno?",'¿Diez horas cogiendo o diez segundos?', "¿Que te encaren o encarar?", "¿Pico o Chape?", "¿Montaña o playa?", "¿Gusto de helado favorito?", "¿Te gusta la menta granizada?", "¿Cerveza o fernet?", "¿Cómo fue tu peor vez...?", "¿Hombre, mujeres, ambos o perros?", "¿Es más pesada una piedra de un kg que un almohadon con un kg de plumas?", "¿Te chaparias a la persona que tenes al lado?", "¿Cuál es el mejor trago?", "¿Arriba o abajo?", "¿A quién le darías un beso de los que están acá?", "¿Con quién de acá harias una película xxx?",'¿Volverias con tu ex?','¿Preferís estar con tu mejor amigo/a o volver con tu ex?','¿Estás en algo con alguien?','¿Contra cuantos nenes de 7 años podes pelear?'],
            ...
            ing: ["¿Cuáles son los primeros 5 números de π?", "¿Qué es el teorema central del límite?", "¿Qué es una distribución Bernoulli?", "Una binomial es una suma de...","¿Que es una corriente parásita?", "¿Que es la reluctancia?","¿Qué es el factor de potencia?", "¿Cuál es la derivada de xˆ2?", "¿Cuál es la integral de xˆ2?", "¿Que es S en Laplace?", "¿Cómo demostras algo por inducción?", "¿Que es un volumen de control?", "¿Que es una ecuación diferencial?", "¿Cuando la derivada de una función se hace cero que esta pasando?", "Enuncia la ley de Ohm", "Enuncia el teorema de Bolzano","¿Qué es un MRP?","¿Qué es la entropia?","¿Qué es la entalpía?","¿El voltaje es proporcional o inversamente proporcional a la corriente?",'¿Cuántos elefantes hay en un mol de elefantes?'], 

            general: ["¿Cuál es la distancia de la tierra a la luna?", "¿Cuál es el promedio de pelos en un hombre?", "¿En qué año fue la primera guerra mundial?", "¿En qué año fue la segunda Guerra Mundial?", "¿Cuántas personas hay en la tierra?", "¿Cuántas estrellas hay en el universo?", "¿Quién es el hombre más rico del mundo?", "¿Quién es Peter Parker?", "¿Quién dijo la frase ‘Un gran poder conlleva una gran responsabilidad’?", "¿Cuánto tiempo viven los perros?", "¿Cuánto tiempo viven los gatos?",'¿En que año se firmó la declaración de independencia Argentina?','¿Cuando fue la revolución de mayo?','¿Quién fue Tesla?','¿Cuántos elefantes hay en un mol de elefantes?','¿Crecen más rápido las uñas del pie o las de la mano?', '¿Cuál es el país más grande del mundo?','¿Cuál es el país más rico del mundo?','¿Cuántas provincias tiene Argentina?','¿Cuántos países hay en america latina?','¿Cuántos países hay en el mundo?','¿Cuál es la capital de Rusia?','¿Cual es la capital de Alemania?','¿Cuál es la capital de Colombia?','¿Cuántos habitantes tiene China?','¿Cuántos panes vende Bimbo por año?','¿Cuántos autos hay en el mundo?','¿Cuántas especies de insectos existen?','¿Cuántas especies animales hay?','¿Cuántas estrellas hay en nuestra galaxia?','En orden... ¿cuales son los planetas del sistema solar?'],

            picante: ["¿Pasar hambre o sed?", "¿Perdonaste una infidelidad?", "¿Comer hamburguesa por un año o nunca más comer algo que te guste?", "¿Ser millonario o morir virgen?", "¿Vivir 200 años sin amor o vivir 30 con amor?", "¿Te gusta dar o que te den por adelante o por atras?", "¿Probaste en el auto?", "¿Te sentas en la torta?", "¿Te chaparias a la persona que tenes al lado?", "¿Tragas o escupís?", "¿Estar con tu padre en el cuerpo de tu pareja o con tu pareja en el cuerpo de tu padre?", "¿Cómo preferis morirte?", "¿Arriba o abajo?", "¿Que tipo de nopor miras?", "¿Cambiaron tus gustos de nopor en el tiempo?", "¿Buscarías ayuda terapéutica para solucionar algún problema sexual?", "¿Usas algo para hacer más intensa la experiencia en la cama...? ¿Qué?", "¿Cuando y cómo fue tu primera vez?", "¿Alguna vez pagaste por sexo?", "¿Alguna vez te pagaron por sexo?", "¿Previa antes del acto sexual o no?", "¿Cuál es la previa perfecta antes de...?", "¿Dominar o ser dominado?", "¿Cada cuánto y cómo le das al ganzo?", "¿En que pensas cuando te tocas?", "¿Cuál fue tu experiencia más incómoda en la cama?", "¿Sexo rápido o prolongado?", "¿Te gusta dar o que te den por el chiquito?", "¿Alguna vez estuviste con alguien que no debías?", "¿Algo que quieras probar en la cama?", "¿Salvaje o romántico?", "¿Decís que no cuando no te gusta?", "¿Te gusta sextear?",'¿Diez horas cogiendo o diez segundos?'], 

            conocer: ['¿Cuál es tu color favorito?', '¿Cuál es tu gusto de helado favorito?', '¿Pizza o Hamburguesa?', '¿Cuantas parejas tuviste?', '¿Cuál es tu comida favorita?', '¿Fernet o cerveza?', '¿Qué tipo de música escuchas?','¿Cuántas mascotas tenés?']
        }, 
